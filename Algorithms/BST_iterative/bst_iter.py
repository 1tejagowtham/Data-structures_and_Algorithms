def binary_search(sorted_list, target):
  ...
  while left_pointer < right_pointer:
    ...
    # calculating the middle index using the two pointers
    ...
    if target < mid_val:
      ...
      # setting the right_pointer to the appropriate value
      right_pointer = mid_idx
    if target > mid_val:

      # setting the left_pointer to the appropriate value
